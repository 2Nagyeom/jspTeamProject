		...
		<div id="container">
			...
			<div id="menubar">
				...
				<br> <a id="menuitem"
					...
					href="reviewPage.jsp">리뷰게시판</a> <a id="menuitem"
					style="text-decoration-line: none; margin-left: 7%; font-size: 160%; font-family: 'Nanum Brush Script', cursive;"
					href="openPage.jsp">오픈채팅</a>
			</div>
			...
			<div class="col text-center" style="padding-bottom: 2%; margin-left: 50%"></div>
			<p>
				<button style=" font-family: 'Nanum Brush Script', cursive;" type="button"
