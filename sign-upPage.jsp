...
<body style="background: linear-gradient(to top, #F8E0F1, white)";>
	...
	<div id="inputt" style="margin-top:10%;">
	<form action="./dbprocess/registerPro.jsp" method="post"
		class="upForm">
		<h2 style="font-family: 'Nanum Brush Script', cursive;">Sign-up</h2>
		<div class="idForm">
		...
		<div class="passcheckForm">
			<input style="font-family: 'Nanum Brush Script', cursive;"
				type="password" class="pwcheck" name="pwcc" placeholder="비밀번호확인">
		</div>
		<div class="nameForm">
			<input style="font-family: 'Nanum Brush Script', cursive;"
				type="text" class="name" name="name" placeholder="이름">
		</div>
		<div class="addressForm">
			<input style="font-family: 'Nanum Brush Script', cursive;"
				type="text" class="addr" name="addr" placeholder="ADDRESS">
		</div>
		<div class="numberForm">
			<input style="font-family: 'Nanum Brush Script', cursive;"
				type="text" class="num" name="num" placeholder="NUMBER">
		</div>
		<button style="font-family: 'Nanum Brush Script', cursive;"
			type="submit" class="btn">Sign-up</button>
		<button style="font-family: 'Nanum Brush Script', cursive;"
			type="button" class="btnno" onclick="location.href='mainPage.jsp'">뒤로가기</button>
	</form>
	</div>
</body>
</html>